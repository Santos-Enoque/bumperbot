...
static rosidl_typesupport_introspection_c__MessageMember nav2_msgs__action__ComputeRoute_Result__rosidl_typesupport_introspection_c__ComputeRoute_Result_message_member_array[4] = {
  {
    "planning_time",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
